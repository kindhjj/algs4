...
public class Point implements Comparable<Point> {
    ...
    private class slopeComparator implements Comparator<Point> {
        ...
        public int compare(Point p1, Point p2) {
            double slope1 = pp.slopeTo(p1);
            double slope2 = pp.slopeTo(p2);
            double slope = slope1 - slope2;
            if (slope > 0) return 1;
            else if (slope == 0 || (slope1 == Double.POSITIVE_INFINITY
                    && slope2 == Double.POSITIVE_INFINITY) || p1.compareTo(p2) == 0) return 0;
            else return -1;
        }
    }
